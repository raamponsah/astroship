import { B as AstroUserError, A as AstroError } from "./chunks/astro/assets-service_C9ni2zx6.mjs";
import React, { createElement } from "react";
import ReactDOM from "react-dom/server";
import { k as AstroJSX, b as renderJSX, l as createVNode } from "./chunks/astro/server_O8A7kLy3.mjs";
const opts = {
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
  ...
  if (children && opts.experimentalReactChildren) {
    ...
    const convert = await import("./chunks/vnode-children_BeL9aKBN.mjs").then((mod) => mod.default);
